...
class RRT():
    ...
    def __init__(self, obst=None):
        ...
        # default to empty list if obstacles not found
        self.obstacles = obst or []
    
        # define a simple setup class
        self.ss = oc.SimpleSetup(self.cspace)
        isValidFn = ob.StateValidityCheckerFn(partial(self.collision_checker(self.obstacles), self.ss.getSpaceInformation()))
    ...
    def collision_checker(self, state, obstacle):
        ...
        # satisfied
            ...
            for x in obstacle:
                ...
                radius = 1.5np.max(obstacle_size) #should add a factor of safety
